...
import com.WWcli.tui.history.ConversationSnapshot;
import com.WWcli.tui.pane.CenterPane;
import com.WWcli.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final WWcliConfig config;
    ...
    public TuiSessionController(WWcliConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "WWcli-tui-agent-runner");
