    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[WWcli] stdout reader stopped: " + e.getMessage());
            }
        }, "WWcli-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[WWcli] stderr reader stopped: " + e.getMessage());
            }
        }, "WWcli-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
