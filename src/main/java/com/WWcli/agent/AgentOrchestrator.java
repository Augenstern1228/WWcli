...
public class AgentOrchestrator {
     ...
     */
    public void setSkillSystem(com.WWcli.skill.SkillRegistry skillRegistry,
                               com.WWcli.skill.SkillContextBuffer skillContextBuffer) {
    ...
    private void runBatchParallel(List<ExecutionStep> batch, List<ExecutionStep> steps,
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread t = new Thread(r, "WWcli-multi-agent");
            t.setDaemon(true);
            return t;
        });
