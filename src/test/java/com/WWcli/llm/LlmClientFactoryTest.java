...
class LlmClientFactoryTest {
    ...
    void createsGlm5vTurboClientWithMultimodalEndpoint() {
        WWcliConfig config = new WWcliConfig();
        config.getProviders().put("glm",
                new WWcliConfig.ProviderConfig("test-glm-key", null, "glm-5v-turbo"));
    ...
    void createsStepClientFromConfiguredProvider() {
        ...
        config.getProviders().put("step",
                new WWcliConfig.ProviderConfig("test-step-key", null, "step-3.5-flash-2603"));
    ...
    void createsStepClientFromStepfunAliasAndCustomBaseUrl() {
        ...
        config.getProviders().put("step",
                new WWcliConfig.ProviderConfig(
                        "test-step-key",
    ...
    void returnsNullForUnknownProvider() {
        WWcliConfig config = new WWcliConfig();
        config.getProviders().put("unknown", new WWcliConfig.ProviderConfig("test-key", null, "unknown-model"));
