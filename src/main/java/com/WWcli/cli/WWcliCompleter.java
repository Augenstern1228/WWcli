...
import com.WWcli.mcp.mention.AtMentionCompleter;
...
final class WWcliCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    WWcliCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
