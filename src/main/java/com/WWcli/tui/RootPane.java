...
import com.WWcli.tui.pane.FileTreePane;
import com.WWcli.tui.pane.InputBar;
...
public class RootPane extends Panel {
     ...
     */
    public RootPane(WWcliConfig config, LlmClient llmClient) {
        super();
    ...
    public boolean handleInput(KeyStroke keyStroke) {
        ...
        if (keyStroke.getKeyType() == KeyType.Character && keyStroke.isCtrlDown() && keyStroke.getCharacter() == 'P') {
            centerPane.appendSystemMessage("对话历史已持续保存到 ~/.WWcli/history/。");
            return true;
        }
