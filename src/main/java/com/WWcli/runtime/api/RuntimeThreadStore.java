...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("WWcli.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("WWCLI_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = Path.of(System.getProperty("user.home"), ".WWcli", "runtime").toString();
        }
