...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(WWcliConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("WWcli v16.0.0");
