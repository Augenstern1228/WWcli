...
public class LongTermMemory implements Memory {
    ...
    private static final String STORAGE_DIR_PROPERTY = "WWcli.memory.dir";
    private static final String STORAGE_DIR_ENV = "WWCLI_MEMORY_DIR";
    ...
    private static File resolveStorageDir() {
        ...
        return new File(new File(System.getProperty("user.home"), ".WWcli"), "memory");
    }
